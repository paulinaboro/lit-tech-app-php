...
$q = $db->prepare("SELECT DISTINCT lessons.lesson_id, detailed_courses.course_id, lessons.lesson_name, lessons.topic, lessons.title, lessons.text_content, lessons.lesson_award_text, lessons.img_path, lessons.completed FROM lessons, detailed_courses WHERE detailed_courses.course_id=$course_id ORDER BY lessons.lesson_id");
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="../user-panel.php">All Courses</a>
          <a class="dropdown-item" href="../user-courses.php">My Courses</a>
...
<form id='mainForm'>
       ...
       <?= $sLessonsBox ?>
       <fieldset data-field="fieldset7" id="fieldset7" class="hidden">
    <div class="container">
  
  <div class="row">
  <div class="col-12 lastLesson"><h3 class='congrats'>Congratulations! You have completed full course!</h3>
         
         <a href="../user-courses.php">Go back</a></div>
  </div>
